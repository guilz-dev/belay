...
export const READ_ONLY_KEYS = new Set(READ_ONLY_COMMAND_KEYS);
export const FLAGGED_KEYS = new Set(FLAGGED_COMMAND_KEYS);
export const EXTERNAL_KEYS = new Set(EXTERNAL_COMMAND_KEYS);
