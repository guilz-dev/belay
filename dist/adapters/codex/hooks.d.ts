 ...
 */
export declare function renderCodexHooksToml(platform?: NodeJS.Platform): string;
/**
 ...
 */
export declare function mergeCodexHooksToml(existing: string, platform?: NodeJS.Platform): string;
export declare function getCodexManagedHookEntries(platform?: NodeJS.Platform): Array<{
    event: string;
    definition: {
        command: string;
        placement: 'prepend';
