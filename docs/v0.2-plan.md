...
- [ ] `src/core/*` へ分類・承認ロジックを抽出
- [ ] テンプレート生成を core bundle 経由に変更
- [ ] 既存 E2E テスト維持

### Phase B — 分類・ゲート

- [ ] チェーン/パイプ解析
- [ ] コマンド・サブエージェント辞書拡張 + 誤検知ルール
- [ ] `preToolUse` Shell / Write 系ゲート
- [ ] config v2 + マイグレーション

### Phase C — 運用

- [ ] `status`, `explain`, `upgrade`, `revoke`
- [ ] `doctor` バージョン検査

### Phase D — リリース

- [ ] README Roadmap 更新（v0.2 完了 / v0.3 予告）
