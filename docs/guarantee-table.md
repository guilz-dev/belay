...
| L1 partial (egress) | Egress proxy + L3+L4 | HTTP(S) observed at proxy; L3 external rules become hints while proxy runs | Not protected — proxy bypass / raw sockets remain | `l1p-allow-readonly`, `l1p-deny-external-without-proxy` |
